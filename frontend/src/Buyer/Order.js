    ...
    if(orderDetails.length>0){
            ...
            <div className="container">
                <div className="row">
                                        ...
                                        <div className="text-wrap ">
                                            ...
                                            <tbody>
                                                    ...
                                                    <tr >
                                                        ...
                                                        <td> 
                                                            <var className="price">{o.status} </var>
                                                        </td>
                    ...
                    <div style={{textAlign: 'center' , marginTop: '25px', marginBottom: '25px'}} >
                        <img src="images/emptyicons/no_orders.png" style={{justifyContent:'center'}} />	   
                    </div> 
            </div> 
        </section>
        )
        ...
        return(
            <div style={{textAlign: "center", marginTop: "5px" }}>	
                    <img src="/images/Cards/empty_orders.png " style={{justifyContent: "center"}} />	  
                    <div>

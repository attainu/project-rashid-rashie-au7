        ...
        <div className="row align-items-center" style={{backgroundColor: "#353b48"}}>
                ...
                <div className="col-xl-4 col-lg-5 col-md-6">
                    <div className="widgets-wrap float-md-right">
                        ...
                        <div className="widget-header mr-3">
                            <a className="nav-link dropdown-toggle" data-toggle="dropdown" > <i className="fa fa-user" style={{color: 'white'}}></i> Accounts </a>
                            <div className="dropdown-menu">
                                ...
                                {!isAuthenticate() && (
                                    <Fragment>
                                        <Link className="dropdown-item"  to="/register"><i className= "fa fa-sign-in" aria-hidden="false"  />Signup</Link>
                                        <Link className="dropdown-item"   to="/login"><i className="" />Signin</Link>
                                    </Fragment>
                                )}
                                {isAuthenticate() && ( 
